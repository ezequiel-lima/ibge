...
{
    public class CreateIbgeContract : Contract<CreateIbgeViewModel>
    {
        public CreateIbgeContract(CreateIbgeViewModel model)
        {
        ...
        private void AcceptsOnlyWholeNumbers(CreateIbgeViewModel model)
        {
